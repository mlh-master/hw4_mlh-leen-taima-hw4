...
# flatten images
x_train = BaseX_train.reshape(BaseX_train.shape[0], 32**2)
x_val = BaseX_val.reshape(BaseX_val.shape[0], 32**2)
...
history = model_relu.fit(x_train, BaseY_train,
...
history_2_25 = new_a_model.fit(x_train, BaseY_train,
          batch_size=batch_size, epochs=epochs,
          validation_data=(x_val, BaseY_val))
...
history_2_40 = new_a_model.fit(x_train, BaseY_train,
          batch_size=batch_size, epochs=epochs,
          validation_data=(x_val, BaseY_val))
...
history_mini = model_relu.fit(x_train, BaseY_train,
          batch_size=batch_size, epochs=epochs,
          validation_data=(x_val, BaseY_val))
...
history_new_mini = new_a_model.fit(x_train, BaseY_train,
          batch_size=batch_size, epochs=epochs,
          validation_data=(x_val, BaseY_val))
